 ...
 */
@WebServlet("/showProductUI")
public class ShowProductUIServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//查PageBean的数据
		PageBean page = productService.findPageBean(currentCid,currentPage,currentCount);
