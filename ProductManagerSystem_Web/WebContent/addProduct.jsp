			...
			<div class="row">
				<div class="col-lg-12 heading">
					<h1 class="page-header">
						<i class="im-paragraph-justify"></i> 添加商品
					</h1>
				</div>
			</div>
			<div class="outlet">
					...
					<div class="col-lg-12">
						<div class="panel panel-default toggle">
							<div class="panel-heading">
								<h3 class="panel-title">添加商品信息</h3>
							</div>
							<div class="panel-body">
								<form class="form-horizontal group-border hover-stripped"
									role="form" action='addProduct' method='post'>
									...
									<div class="form-group">
										...
										<div class="col-lg-10 col-md-10">
											<input type="text" class="form-control"
												placeholder="请输入商品名称" name="p_name">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-lg-10 col-md-10">
											<input type="number" step="0.01" class="form-control"
												placeholder="请输入商品价格" name='p_price'>
										</div>
									</div>
									<div class="form-group">
